...
Режим перемещения/копирования также можно указать ключами командной строки
-m/--move, -c/--copy и из графического интерфейса.
...
Также графический и терминальный режимы можно выбирать, указывая в командной
строке ключи --gui/--no-gui.
