...
Все параметры задаются в файле photomv.ini (если он существует).
...
Каталог назначения. При отсутствии создаётся. Подкаталоги создаются при
перемещении (копировании) файлов на основе шаблонов.
...
применяется шаблон по умолчанию, заданный внутри программы (см. ниже).
...
разделители путей ("/") и/или произвольный текст.
